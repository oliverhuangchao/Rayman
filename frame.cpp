...
Frame::Frame( const std::string& name, const std::string& second, SDL_Surface* surf ) : 
  screen(IOManager::getInstance().getScreen()),
  surface( surf ),
  width(Gamedata::getInstance().getXmlInt(name + "/" + second + "/width")), 
  height(Gamedata::getInstance().getXmlInt(name + "/" + second + "/height")),
  sourceX(0),
  sourceY(0)
{}

Frame::Frame( const std::string& name, const std::string& second, SDL_Surface* surf, double zoomInteger ) : 
  screen(IOManager::getInstance().getScreen()),
  surface( surf ),
  width(Gamedata::getInstance().getXmlInt(name + "/" + second + "/width") * zoomInteger), 
  height(Gamedata::getInstance().getXmlInt(name + "/" + second + "/height") * zoomInteger),
  sourceX(0),
  sourceY(0)
{}
